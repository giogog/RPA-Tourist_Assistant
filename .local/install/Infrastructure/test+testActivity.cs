...
namespace Tourist_Assistant.Infrastructure
{
    [System.ComponentModel.Browsable(false)]
    public class testActivity : System.Activities.Activity
    {
        public InArgument<System.String> rame { get; set; }
        ...
        public testActivity()
        {
            this.Implementation = () =>
            {
                ...
                {rame = (this.rame == null ? (InArgument<System.String>)Argument.CreateReference((Argument)new InArgument<System.String>(), "rame") : (InArgument<System.String>)Argument.CreateReference((Argument)this.rame, "rame")), };
            };
        }
    }

    internal class testActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public InArgument<System.String> rame { get; set; }
        ...
        {
            var var_rame = rame.Get(context);
            var codedWorkflow = new global::Tourist_Assistant.test();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Infrastructure\\test.cs"});
                }
            ...
            }, () =>
            {
                ...
                {
                    {
                        codedWorkflow.Execute(var_rame);
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Infrastructure\\test.cs", Exception = exception});
                }
